          ...
          <div className="px-4 pb-4">
              ...
              <div className="flex items-center space-x-1 rtl:space-x-reverse">
                {[...Array(5)].map((_, index) => (
                  <svg
                    ...
                    className={`w-6 h-6 ${index < (getAverageRating(product._id) / 2) ? 'text-yellow-300' : 'text-gray-200 dark:text-gray-600'} cursor-pointer`}
                    aria-hidden="true"
            ...
            <div className="flex items-center justify-between">
              <div className="flex space-x-2">
                <a href="#" className="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800 transition duration-300">
                  Add to cart
                </a>
                <Link to="/page" state={{id:product._id}} className="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-500 dark:hover:bg-green-600 dark:focus:ring-green-800 transition duration-300">
                  View Product
                </Link>
              </div>
            </div>
